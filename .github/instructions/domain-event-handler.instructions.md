---
applyTo: "src/Bumpic.Web/Application/DomainEventHandlers/*.cs"
---
...
- 类文件应放置在 `src/Bumpic.Web/Application/DomainEventHandlers/` 目录下。
...
using Bumpic.Web.Domain.DomainEvents;
