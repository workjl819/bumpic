...
- 领域层测试：`test/Bumpic.Domain.Tests/{EntityName}Tests.cs`。
- Web 层测试：`test/Bumpic.Web.Tests/{Feature}Tests.cs`。
- 基础设施层测试：`test/Bumpic.Infrastructure.Tests/{Component}Tests.cs`。
