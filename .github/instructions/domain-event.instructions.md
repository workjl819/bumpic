---
applyTo: "src/Bumpic.Domain/DomainEvents/*.cs"
---
...
- 类文件应放置在 `src/Bumpic.Domain/DomainEvents` 目录下。
- 为每个聚合添加一个领域事件文件。
...
**文件**: `src/Bumpic.Domain/DomainEvents/UserDomainEvents.cs`

```csharp
using Bumpic.Domain.Aggregates.UserAggregate;
