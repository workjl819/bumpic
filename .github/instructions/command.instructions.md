---
applyTo: "src/Bumpic.Web/Application/Commands/**/*.cs"
---
...
- 类文件应放置在 `src/Bumpic.Web/Application/Commands/{Module}s/` 目录下（以模块复数形式命名，避免命名空间与聚合类名冲突）。
...
**文件**: `src/Bumpic.Web/Application/Commands/Users/CreateUserCommand.cs`

```csharp
using Bumpic.Domain.AggregatesModel.UserAggregate;
using Bumpic.Infrastructure.Repositories;

namespace Bumpic.Web.Application.Commands.Users;
